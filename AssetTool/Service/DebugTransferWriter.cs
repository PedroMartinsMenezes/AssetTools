///namespace AssetTool
///{
///    public class DebugTransferWriter : TransferWriter
///    {
///        public DebugTransferWriter(BinaryWriter writer) : base(writer) { }

///        static DebugTransferWriter()
///        {
///            File.WriteAllText("C:/Temp/DebugTransferWriter.log", "");
///        }

///        protected virtual void Log(long position1, long position2)
///        {
...
///                File.AppendAllLines("C:/Temp/DebugTransferWriter.log", [content]);
///            }
///        }

///        protected virtual T Log<T>(Func<T> func)
///        {
