...
namespace AssetTool
{
    public class FManagedArrayBase : ITransferible
    {
        ...
        public List<uint8> UInt8;
        public List<UInt32> VectorArrayPointer;
        public List<TList<FVector3f>> VectorArrayUniquePointer;
        public List<UInt32> FImplicitObject3Pointer;
        ...
        public List<UInt32> TPBDRigidClusteredParticleHandle3fPtr;
