namespace AssetTool
{
    ...
    [JsonAsset("UniformInteger")] public class UUniformInteger : UFieldNodeInt { }
    [JsonAsset("RadialIntMask")] public class URadialIntMask : UFieldNodeInt { }
    [JsonAsset("UniformScalar")] public class UUniformScalar : UFieldNodeFloat { }
    ...
    [JsonAsset("UniformVector")] public class UUniformVector : UFieldNodeVector { }
