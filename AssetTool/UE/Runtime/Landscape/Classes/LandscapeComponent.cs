namespace AssetTool
{
    ...
    public class FLandscapeComponentGrassData : ITransferable
    {
        ...
        public Dictionary<TUInt32, List<TUInt8>> DeprecatedWeightData;
