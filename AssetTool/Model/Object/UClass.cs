namespace AssetTool
{
    ...
    public static class UClassExt
    {
        public static void Write(this BinaryWriter writer, UClass item)
        {
            ...
            writer.WriteValue(item.FuncMap, item.GetType().GetField("FuncMap"));//68730..68806
            ...
            writer.WriteValue(item.SerializedInterfaces, item.GetType().GetField("SerializedInterfaces")); //68826..68830
        ...
        public static UClass Read(this BinaryReader reader, UClass item)
        {
            ...
            reader.ReadValue(item.FuncMap, item.GetType().GetField("FuncMap"));//68730..68806
            ...
            reader.ReadValue(ref item.SerializedInterfaces, item.GetType().GetField("SerializedInterfaces")); //68826..68830
