namespace AssetTool
{
    public static class GlobalObjects
    {
        ...
        static GlobalObjects()
        {
            ...
            AssetReaders.Add(UBodySetup.TypeName, (myReader, myAsset) => myAsset.Get<UBodySetup>().Move(Transfer));
            AssetReaders.Add(UFbxStaticMeshImportData.TypeName, (myReader, myAsset) => myAsset.Get<UFbxStaticMeshImportData>().Move(Transfer));
            AssetReaders.Add(UNavCollision.TypeName, (myReader, myAsset) => myAsset.Get<UNavCollision>().Move(Transfer));
            AssetReaders.Add(UStaticMesh.TypeName, (myReader, myAsset) => myAsset.Get<UStaticMesh>().Move(Transfer));
            AssetReaders.Add(UStaticMeshDescriptionBulkData.TypeName, (myReader, myAsset) => myAsset.Get<UStaticMeshDescriptionBulkData>().Move(Transfer));
            ...
            AssetWriters.Add(UBodySetup.TypeName, (myWriter, myAsset) => ((UBodySetup)myAsset.Obj).Move(Transfer));
            AssetWriters.Add(UFbxStaticMeshImportData.TypeName, (myWriter, myAsset) => ((UFbxStaticMeshImportData)myAsset.Obj).Move(Transfer));
            AssetWriters.Add(UNavCollision.TypeName, (myWriter, myAsset) => ((UNavCollision)myAsset.Obj).Move(Transfer));
            AssetWriters.Add(UStaticMesh.TypeName, (myWriter, myAsset) => ((UStaticMesh)myAsset.Obj).Move(Transfer));
            AssetWriters.Add(UStaticMeshDescriptionBulkData.TypeName, (myWriter, myAsset) => ((UStaticMeshDescriptionBulkData)myAsset.Obj).Move(Transfer));
